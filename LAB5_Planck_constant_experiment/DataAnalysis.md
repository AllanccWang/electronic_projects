...
since it's red LED, we assume wavelength is 700nm [(red_LED_datasheet)](RED_LED_datasheet/RED_LED_datasheet.pdf). And Planck constant is defined as $6.626*10^{-34}$. below is the table manifests all caculated results for 3 units of red LED.
